...
public class MedsTest {
  ...
  @Test
  void deserialize() {
    var xml = IOUtils.toString(getClass().getResourceAsStream("/SampleMedsResult.xml"));
    ...
    assertThat(VprGetPatientData.create().fromResults(List.of(result)))
        .isEqualTo(VprGetPatientDataSamples.Response.create().responseFor(medsSamples.meds()));
  }
